...
@pytest.mark.parametrize("params", [("partial_ooc", True, False), ("partial_prr", False, True)])
def test_vivado_partial_reconfiguration(params, tmpdir):
    import os
